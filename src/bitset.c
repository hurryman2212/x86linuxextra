...
unsigned char bitset_test(const bitset_t *bitset32, uint32_t idx) noexcept {
...
unsigned char bitset_set(bitset_t *bitset32, uint32_t idx) noexcept {
...
unsigned char bitset_unset(bitset_t *bitset32, uint32_t idx) noexcept {
  bitset_t *_bitset = bitset32 + (idx >> 6);
